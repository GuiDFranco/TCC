<footer class="p-4 bg-dark:bg-gray-900 sm:p-6 dark:bg-gray-900">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <!-- <div>
                    <h2 class="mb-6 text-sm  text-black uppercase dark:text-white">Resources</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm  text-black uppercase dark:text-white">Follow us</h2>
                    <ul class="text-white-900 dark:text-white">
                        <li class="mb-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm  text-black uppercase dark:text-whitee">Legal</h2>
                    <ul class="text-white-900 dark:text-white">
                        <li class="mb-4">
